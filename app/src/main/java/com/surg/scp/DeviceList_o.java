...
public class DeviceList_o extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener,
    ...
    // Add this variable at the top with other timer variables
...
//----------------------------Grant storage permission--------------------------------------------------
        ...
        address = newint.getStringExtra(DeviceList_o.EXTRA_ADDRESS); //receive the address of the bluetooth device
        info_address = newint.getStringExtra(DeviceList_o.EXTRA_INFO);
        if (address != null) {
 ...
 ***************************************************************************************/
    ...
    private void pairedDevicesList() {
        ...
        LinearLayout parent = new LinearLayout(DeviceList_o.this);
...
/* else if (id == R.id.action_about) {
    ...
    public void exitApplication() {
        ...
        adb.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(DeviceList_o.this, "Cancel",
  ...
  /*  public class BluetoothConnectionManager {
    ...
    private void Disconnect() {
        if (btSocket != null) //If the btSocket is busy
        {
            try {
                ...
                Toast.makeText(DeviceList_o.this, "Bluetooth device has been disconnected", Toast.LENGTH_LONG).show();
                // getSupportActionBar().setTitle(R.string.app_name);
            } catch (IOException e) {
                msg("Error");
            }
        } else {
            Toast.makeText(DeviceList_o.this, "No device connected", Toast.LENGTH_LONG).show();
        }
    ...
    private void startCountDownTimer() {
        ...
        // Use paused time if available, otherwise use the full time
        long startTime = (pausedCountDownTimeInSeconds > 0) ? pausedCountDownTimeInSeconds * 1000L : timeVarEdit * 1000L;
        ...
        countDownTimer = new CountDownTimer(startTime, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                if (cdflag == 1) {
                    ...
                    // Store the current time for pausing
    ...
    public void resetTimer() {
        ...
        if (isCountUp) {
            ...
            timeVarEdit = timeVar; // Reset the countdown time
            updateTimerDisplay(method5(timeVar));
        }
    }
    ...
    private void timeDone() {
        ...
        // Reset paused times when timer finishes
        pausedTimeInSeconds = 0;
        pausedCountDownTimeInSeconds = 0;
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        AlertDialog.Builder builder = new AlertDialog.Builder(DeviceList_o.this);
        ...
        builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(DeviceList_o.this, "Yes i wanna exit", Toast.LENGTH_LONG).show();
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // TODO Auto-generated method stub
                Toast.makeText(DeviceList_o.this, "i wanna stay on this", Toast.LENGTH_LONG).show();
                dialog.cancel();
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_ACL_CONNECTED.equals(action)) {
                if (ActivityCompat.checkSelfPermission(DeviceList_o.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                    // TODO: Consider calling
                    //    ActivityCompat#requestPermissions
                    // here to request the missing permissions, and then overriding
                    //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
